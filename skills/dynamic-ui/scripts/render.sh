...
# Render with agent-browser (wkhtmltoimage not available on macOS arm64)
agent-browser open "file://$TEMP_DIR/render.html" >/dev/null 2>&1
sleep 0.5
agent-browser screenshot --full "$OUTPUT_FILE" >/dev/null 2>&1
